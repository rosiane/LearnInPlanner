...
public class MnistDeepLearningZeroUmDoisQuatroClassesTest {
...
//		testPaperParametersComDeepLearning();
	...
	private static void testWithoutDeepLearning() throws IOException {
		int quantityTraining = 20393;
		int quantityValidation = 818;
		int quantityTest = 4099;
		...
		String pathTraining = "./data/MNIST/normal/mnist_train_0_1_2_4_binary.csv";
		String pathValidation = "./data/MNIST/normal/mnist_validation_0_1_2_4_binary.csv";
		String pathTest = "./data/MNIST/normal/mnist_test_0_1_2_4_binary.csv";
		String fileResult = "./data/MNIST/normal/resultados/Resultados_MNIST_WithoutDeepLearning_ZeroUmDoisQuatro.doc";
		...
		System.out.println("IntervalEpochPercentage: " + intervalEpochPercentage + "\n");
		...
		FileManager.write(fileResult, "IntervalEpochPercentage: " + intervalEpochPercentage + "\n", true);

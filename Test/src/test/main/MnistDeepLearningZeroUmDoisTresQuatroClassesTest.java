...
public class MnistDeepLearningZeroUmDoisTresQuatroClassesTest {
	...
	private static void testWithoutDeepLearning() throws IOException {
		int quantityTraining = 25503;
		int quantityValidation = 1014;
		int quantityTest = 5131;

		int numberAttribute = 784;
		int[] numberUnitHidden = { 50 };
		...
		String pathTraining = "./data/MNIST/normal/mnist_train_0_1_2_3_4_binary.csv";
		String pathValidation = "./data/MNIST/normal/mnist_validation_0_1_2_3_4_binary.csv";
		String pathTest = "./data/MNIST/normal/mnist_test_0_1_2_3_4_binary.csv";
		String fileResult = "./data/MNIST/normal/resultados/Resultados_MNIST_WithoutDeepLearning_ZeroUmDoisTresQuatro.doc";
		...
		System.out.println("IntervalEpochPercentage: "
		...
		FileManager.write(fileResult, "Max error: " + maxError, true);
		FileManager.write(fileResult, "Momentum: " + momentum, true);
		FileManager.write(fileResult, "IntervalEpochPercentage: "
				+ intervalEpochPercentage + "\n", true);

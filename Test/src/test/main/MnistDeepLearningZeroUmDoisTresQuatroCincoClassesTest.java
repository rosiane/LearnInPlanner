...
public class MnistDeepLearningZeroUmDoisTresQuatroCincoClassesTest {
	...
	private static void testWithoutDeepLearning() throws IOException {
		int quantityTraining = 30055;
		int quantityValidation = 1199;
		int quantityTest = 5994;
		...
		String pathTraining = "./data/MNIST/normal/mnist_train_0_1_2_3_4_5_binary.csv";
		String pathValidation = "./data/MNIST/normal/mnist_validation_0_1_2_3_4_5_binary.csv";
		String pathTest = "./data/MNIST/normal/mnist_test_0_1_2_3_4_5_binary.csv";
		String fileResult = "./data/MNIST/normal/resultados/Resultados_MNIST_WithoutDeepLearning_ZeroUmDoisTresQuatroCinco.doc";

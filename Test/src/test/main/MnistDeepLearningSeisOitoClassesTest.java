...
public class MnistDeepLearningSeisOitoClassesTest {
	private static int quantityTraining = 9804;
	private static int quantityValidation = 377;
	private static int quantityTest = 1958;

	private static String pathTraining = "./data/MNIST/normal/mnist_train_6_8_binary.csv";
	private static String pathValidation = "./data/MNIST/normal/mnist_validation_6_8_binary.csv";
	private static String pathTest = "./data/MNIST/normal/mnist_test_6_8_binary.csv";
	...
	private static void testWithoutDeepLearning() throws IOException {
		...
		String fileResult = "./data/MNIST/normal/resultados/Resultados_MNIST_WithoutDeepLearning_SeisOito.doc";
	...
	private static void testPaperParametersComDeepLearning() throws IOException {
		...
		double[] learningRate = { 0.05 /* 0.2 *//* , 0.5, 0.9 */};
		long[] numberEpochs = { 100 /* , 10 */};
		double[] maxError = { 0 /* , 15, 12 */};
		double[] learningRateDecrease = { /*0.99*/ 1};

		// Carregando dados
		String fileResult = "./data/MNIST/normal/resultados/Resultados_MNIST_DeepLearning_SeisOito.doc";
